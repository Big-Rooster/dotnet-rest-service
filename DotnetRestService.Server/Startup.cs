...
using DotnetRestService.Server.HealthChecks;
using DotnetRestService.Server.Middleware;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "DotnetRestService API", Version = "v1" });
        ...
        services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
            .AddJwtBearer(options =>
            {
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    ValidIssuer = Configuration["Authentication:Jwt:Issuer"] ?? "DotnetRestService",
                    ValidAudience = Configuration["Authentication:Jwt:Audience"] ?? "DotnetRestServiceAPI",
        ...
        services.AddSingleton<DotnetRestServiceCore>();
        ...
        services.AddOpenTelemetry()
            ...
            .WithMetrics(metrics =>
            {
                metrics
                    ...
                    .AddMeter("DotnetRestService"); // Add our custom metrics
    ...
    public void Configure(WebApplication app)
    {
        ...
        if (app.Environment.IsDevelopment() || isEphemeral)
        {
            ...
            app.UseSwaggerUI(c => 
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "DotnetRestService API V1");
        ...
        app.MapControllers();
        app.MapGet("/", () => "DotnetRestService REST API Service");
