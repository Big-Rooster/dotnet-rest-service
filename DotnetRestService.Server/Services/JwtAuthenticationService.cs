...
public class JwtAuthenticationService : IAuthenticationService
{
        ...
        ILogger<JwtAuthenticationService> logger)
    {
        ...
        {
          _options.Issuer = configuration["Authentication:Jwt:Issuer"] ?? "DotnetRestService";
        }
        if (string.IsNullOrEmpty(_options.Audience))
        {
          _options.Audience = configuration["Authentication:Jwt:Audience"] ?? "DotnetRestServiceAPI";
        }
