...
public class ValidationService : IValidationService
{
    ...
    public void ValidateCreateRequest(DotnetRestDto request)
    {
    ...
    public void ValidateUpdateRequest(DotnetRestDto request)
    {
        var errors = new Dictionary<string, string[]>();
    ...
    public void ValidatePaginationRequest(GetDotnetRestsRequest request)
    {
        var errors = new Dictionary<string, string[]>();
