...
namespace DotnetRestService.UnitTests.Core;
...
public class ValidationServiceTests
{
    ...
    {
        // Arrange
        var request = new DotnetRestDto { Name = "Valid Name" };
    ...
    {
        // Arrange
        var request = new DotnetRestDto { Name = name };
    ...
    {
        // Arrange
        var request = new DotnetRestDto { Name = new string('a', 101) };
    ...
    {
        // Arrange
        var request = new DotnetRestDto { Name = "Valid Name", Id = Guid.NewGuid().ToString() };
    ...
    {
        // Arrange
        var request = new DotnetRestDto { Id = Guid.NewGuid().ToString(), Name = "Valid Name" };
    ...
    {
        // Arrange
        var request = new DotnetRestDto { Id = id, Name = "Valid Name" };
    ...
    {
        // Arrange
        var request = new DotnetRestDto { Id = "invalid-guid", Name = "Valid Name" };
    ...
    {
        // Arrange
        var request = new GetDotnetRestsRequest { StartPage = 1, PageSize = 10 };
    ...
    {
        // Arrange
        var request = new GetDotnetRestsRequest { StartPage = startPage, PageSize = 10 };
    ...
    {
        // Arrange
        var request = new GetDotnetRestsRequest { StartPage = 1, PageSize = pageSize };
    ...
    {
        // Arrange
        var request = new GetDotnetRestsRequest { StartPage = 1, PageSize = 1001 };
